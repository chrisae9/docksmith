-- Remove 'pending_restart' status (rollback to previous constraint)
-- Note: Any operations with 'pending_restart' status will be lost

-- Step 1: Create table without pending_restart status
...
-- Step 2: Copy data (excluding pending_restart operations)
