-- Revert: Remove 'start' operation type

-- Step 1: Create table without start type
CREATE TABLE update_operations_new (
    ...
    stack_name TEXT,
    operation_type TEXT NOT NULL CHECK(operation_type IN ('single', 'batch', 'stack', 'rollback', 'restart', 'label_change', 'stop', 'remove', 'fix_mismatch')),
...
-- Step 2: Copy data (excluding start operations)
